...
SECRET_KEY = 'django-insecure-n&b()vzac&gbhfqy9=er6vav$oav0pkk1fcfr0kn6vl4gvpz#2'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'user', 'static', 'users/'),
    os.path.join(BASE_DIR, 'moneys', 'static', 'moneys/'),
]
